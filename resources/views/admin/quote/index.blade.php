...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('admin.quotes.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('admin.quotes.index') }}",
	        ...
	        { "mData": "phone",sWidth: "10%",bSortable: true,},
	        { "mData": "company",sWidth: "10%",bSortable: false,},
			{ "mData": "location",sWidth: "10%",bSortable: false,},
			{ "mData": "description",sWidth: "10%",bSortable: false,},
	        {
	            mData: null,
	            bSortable: false,
	            sWidth: "10%",
