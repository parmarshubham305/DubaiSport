...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('admin.cms-pages.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('admin.cms-pages.index') }}",
	        ...
	        { "mData": "sort",sWidth: "10%",bSortable: false,},
	        {
	            mData: null,
	            bSortable: false,
	            sWidth: "10%",
	            ...
	            mRender: function(v, t, o) {
	                ...
	                var editUrl = '{{ route("admin.cms-pages.edit", ":id") }}';
