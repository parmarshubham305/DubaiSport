...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('admin.category-groups.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('admin.category-groups.index') }}",
	        ...
	        { "mData": "icon",
				...
				mRender: function(v, t, o) {
					var img = '';
					if(o['icon'] != '') {
						img = '<img src="'+o['icon']+'" width="40" height="40" style="margin-left: 20px; margin-right: 10px"/>';
					}
	        ...
	        { "mData": "status",sWidth: "10%",bSortable: false,},
	        {
	            ...
	            mRender: function(v, t, o) {
	                ...
	                var editUrl = '{{ route("admin.category-groups.edit", ":id") }}';
