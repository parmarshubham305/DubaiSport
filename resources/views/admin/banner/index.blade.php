...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('admin.banners.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('admin.banners.index') }}",
	        ...
	        { "mData": "sort",sWidth: "10%",bSortable: true,},
	        { "mData": "image",
				sWidth: "10%",
				bSortable: false,
				mRender: function(v, t, o) {
			...
			},
	        {
	            ...
	            mRender: function(v, t, o) {
	                ...
	                var editUrl = '{{ route("admin.banners.edit", ":id") }}';
