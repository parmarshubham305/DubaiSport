...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('admin.states.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('admin.states.index') }}",
	        ...
	        { "mData": "country",sWidth: "10%",bSortable: true,},
	        { "mData": "name",sWidth: "10%",bSortable: true,},
	        { "mData": "delivery_charge",sWidth: "10%",bSortable: true,},
	        {
	            mData: null,
	            bSortable: false,
	            sWidth: "10%",
	            ...
	            mRender: function(v, t, o) {
	                ...
	                var editUrl = '{{ route("admin.states.edit", ":id") }}';
