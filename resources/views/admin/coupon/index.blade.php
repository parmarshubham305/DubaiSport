...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('admin.coupons.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('admin.coupons.index') }}",
	        ...
	        { "mData": "coupon_code",sWidth: "10%",bSortable: true,},
	        { "mData": "start_date",sWidth: "10%",bSortable: true,},
	        { "mData": "end_date",sWidth: "10%",bSortable: true,},
	        { "mData": "percentage",sWidth: "10%",bSortable: true,},
	        {
	            mData: null,
	            bSortable: false,
	            sWidth: "10%",
