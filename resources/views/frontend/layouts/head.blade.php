<head>
    ...
    <title>Dubai Sport</title>
    {{ Html::style("front/thirdparty/css/all.min.css") }}
    {{ Html::style("front/thirdparty/css/animate.min.css") }}
    {{ Html::style("front/thirdparty/css/slick.css") }}
