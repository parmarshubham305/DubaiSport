<div class="product-slider">
    ...
    <div class="card mx-3 position-relative">
        <a href="#" class="product-img"><img src="{{ $product['main_image'] }}" alt="produsct"
        ...
        <div class="card-body bg-light-gray border-top">
            ...
            <p class="fw-semibold mb-1 product-heading"><a href="#">{{ $product['title'] }}</a></p>
            ...
            <a href="{{ route('front.products.show', $product['id']) }}" class="btn btn-info btn-sm">View More</a>
        </div>
    </div>
    @endforeach
</div>
